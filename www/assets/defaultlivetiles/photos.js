...
function draw(args) {
    ...
    tileFeed.addTile(tileFeed.Tile(
        `<p class="show-m" style="margin: 0px; font-size: 60px; font-weight: 200; text-align: left; width: min-content; position: absolute; left: 12px;">PHOTOS <span style="font-size: 0.5em;position: relative; top: -20px;">TEST</span></p>
        <p class="show-w" style="margin: 0px; font-size: 100px; font-weight: 200; text-align: center; width: max-content;">PHOTOS<span style="font-size: 0.5em;">TEST</span></p>
        `
    ))
    return tileFeed;
}
